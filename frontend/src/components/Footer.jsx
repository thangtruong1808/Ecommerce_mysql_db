...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 text-white mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/clearance" className="text-gray-400 hover:text-white">
                  Clearance
                </Link>
              </li>
              <li>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <li>
                    <Link to="/invoices" className="text-gray-400 hover:text-white">
                      Invoices
                    </Link>
                  </li>
                </>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button onClick={() => handleOpenModal('contact')} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Contact Us
                </button>
              </li>
              <li>
                <button onClick={() => handleOpenModal('shipping')} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Shipping Info
                </button>
              </li>
              <li>
                <button onClick={() => handleOpenModal('returns')} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Returns
                </button>
              </li>
              <li>
                <button onClick={() => handleOpenModal('faq')} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  FAQ
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <button onClick={() => handleOpenModal('developer')} className="text-gray-400 hover:text-white transition-colors cursor-pointer">
                  Meet the Developer
                </button>
              </li>
              {/* Social media links */}
      ...
      {/* Modals */}
      <ContactUsModal isOpen={openModal === 'contact'} onClose={handleCloseModal} />
      <ShippingInfoModal isOpen={openModal === 'shipping'} onClose={handleCloseModal} />
      <ReturnsModal isOpen={openModal === 'returns'} onClose={handleCloseModal} />
      <FAQModal isOpen={openModal === 'faq'} onClose={handleCloseModal} />
      <MeetDeveloperModal isOpen={openModal === 'developer'} onClose={handleCloseModal} />
    </footer>
  )
}
