...
const SubcategoryManagement = () => {
  ...
  usePageTitle(loading ? "Loading..." : "Subcategory Management");
  const {
  ...
  const handleBulkDelete = async () => {
    ...
    await crud.handleBulkDelete(
      ids,
      "/api/admin/subcategories/bulk-delete",
      "subcategoryIds"
    );
    clear();
  };
                ...
                {subcategories.length === 0 && !loading ? (
                  ...
                  subcategories.map((subcategory, index) => (
                    <SubcategoryTableRow
                      ...
                      onToggle={toggle}
                      onEdit={() =>
                        crud.setEditModal({ isOpen: true, entity: subcategory })
                      }
                      onDelete={() =>
                        crud.setDeleteModal({
                          isOpen: true,
