      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-evenly sm:items-center mb-2 ">
          ...
          <div className="flex items-center justify-center sm:mt-4 md:mt-0">
            <QuickActionButton
              type="product"
              onCreate={() => setFormModal({ isOpen: true, product: null })}
            />
          </div>
        </div>
                  ...
                  products.map((product, index) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        {product.child_category_name || "N/A"}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <InlineEditCell
                        ...
                        {product.discount_type ? (
                          <div className="flex flex-col gap-1">
                            ...
                            {product.has_discount ? (
                              <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs w-fit">
                                Active
                              </span>
                            ) : product.discount_type ? (
                              <span className="px-2 py-0.5 bg-gray-100 text-gray-600 rounded text-xs w-fit">
                                Inactive
                              </span>
                            ) : null}
                          </div>
