      ...
      <div className="max-w-5xl w-full mx-auto px-4 py-12">
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div className="hidden lg:block bg-white/80 backdrop-blur rounded-2xl p-8 shadow-lg border border-gray-100">
            <p className="text-sm font-semibold text-blue-600 mb-2">Secure access</p>
            <h1 className="text-4xl font-bold text-gray-900 mb-4 leading-tight">
              Welcome back to your shop workspace
            </h1>
            <p className="text-gray-600 mb-6">
              Manage orders, track deliveries, and continue where you left off with a streamlined sign-in built for real retail operations.
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <span className="mt-1 text-blue-600"><FaLock /></span>
                <div>
                  <p className="font-semibold text-gray-900">Enterprise-grade security</p>
                  <p className="text-sm text-gray-600">Encrypted sessions and device-aware protection keep your account safe.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="mt-1 text-blue-600"><FaShieldAlt /></span>
                <div>
                  <p className="font-semibold text-gray-900">Frictionless entry</p>
                  <p className="text-sm text-gray-600">Fast sign-in so you can process carts, vouchers, and fulfillment quicker.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="mt-1 text-blue-600"><FaSmile /></span>
                <div>
                  <p className="font-semibold text-gray-900">Support that cares</p>
                  <p className="text-sm text-gray-600">Need help? Our team is here to get you back on track in minutes.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-gray-500 text-center">
                  By continuing you agree to our standard terms and understand this workspace uses secure cookies.
                </p>
              </div>
            </form>
          </div>
