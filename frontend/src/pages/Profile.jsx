          ...
          <div className="flex justify-between items-center mb-6">
            ...
            {!isEditing && (
              <button
                ...
                className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center space-x-2 transition"
                disabled={isLoading}
              >
          ...
          {isEditing ? (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex space-x-4 pt-4 border-t">
                <button
                  type="submit"
                  className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center space-x-2 transition disabled:opacity-50"
                  disabled={isLoading}
                >
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 flex items-center space-x-2 transition"
                  disabled={isLoading}
                >
                  ...
                  <>
                    ...
                    <div className="space-y-1">
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 capitalize">
                        <FaShieldAlt className="mr-1" /> {p?.role || "user"}
                      </span>
                    </div>
                    <div className="space-y-1">
                      <label className="block text-sm font-medium text-gray-500">
          ...
          {showAddressForm ? (
            ...
            >
              ...
              <div className="flex space-x-4 pt-4 border-t">
                ...
                >
                  {isLoading ? <LoadingSpinner /> : <FaSave />}{" "}
                  <span>{editingAddress ? "Update" : "Add"} Address</span>
                </button>
                <button
                  type="button"
                  onClick={() => {
              ...
              {addresses.map((addr) => (
                ...
                >
                  <div className="flex-1">
                    {addr.is_default && (
                      <span className="inline-block px-2 py-1 mb-2 text-xs font-semibold bg-blue-100 text-blue-800 rounded">
                        Default
                      </span>
                    )}
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            {!isChangingPassword && (
              <button
                ...
                className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 flex items-center space-x-2 transition"
                disabled={isLoading}
              >
                <FaEdit /> <span>Change Password</span>
              </button>
            )}
          </div>
          {isChangingPassword ? (
            ...
            <div className="text-gray-600">
              ...
              <p className="text-sm mt-2">
                For security reasons, we don't display your password.
              </p>
            </div>
          )}
        </div>
