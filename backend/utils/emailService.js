      ...
      html: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
          <div style="margin-bottom: 30px; padding-bottom: 20px; border-bottom: 2px solid #e5e7eb;">
            <div style="display: flex; align-items: flex-start; gap: 15px; margin-bottom: 10px;">
              <img src="${logoUrl}" alt="Ecommerce Store Logo" style="height: 120px; width: auto; object-fit: contain; flex-shrink: 0;" />
              <div style="flex: 1;">
        ...
        shippingAddress.postal_code || ""
          ...
          <div style="text-align: center; margin: 20px 0;">
            <p style="color: #666; font-size: 14px;">Your invoice PDF has been attached to this email for your records.</p>
          </div>
          <div style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-radius: 6px; padding: 15px; margin: 20px 0;">
            ...
            <p style="color: #1e3a8a; font-size: 14px; margin: 0; line-height: 1.6;">Your order will be delivered within <strong>3-5 business days</strong> from the date of shipment. We will integrate shipping tracking with our provider soon, and you'll receive tracking information via email once your order ships.</p>
          </div>
          <p style="color: #666; font-size: 14px; margin-top: 30px; line-height: 1.6;">If you have any questions about your order, please contact our support team. We're here to help!</p>
          <p style="color: #999; font-size: 12px; margin-top: 20px; line-height: 1.5;">This is an automated email. Please do not reply to this message.</p>
